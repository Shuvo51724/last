...
export function ChatBox({ isOpen, onClose }: ChatBoxProps) {
  ...
  const handleSendMessage = () => {
    ...
    sendMessage(messageInput, selectedFile || undefined, undefined, undefined, (progress) => {
              ...
              <div className="border-t p-4">
                ...
                <div className="flex gap-2">
                  {settings.fileSharingEnabled && (
                    <>
                      ...
                      <Button
                        ...
                        disabled={!isConnected || (user ? isUserMuted(user.userId) : false)}
                      >
                  ...
                  <Button
                    ...
                    disabled={!isConnected || (!messageInput.trim() && !selectedFile) || (user ? isUserMuted(user.userId) : false)}
                  >
            ...
            {message.fileType?.startsWith('image/') ? (
              ...
              <div>
                ...
                >
                  ...
                  <span className="truncate">Download {message.fileName}</span>
                </a>
              </div>
            ) : (
              <a
